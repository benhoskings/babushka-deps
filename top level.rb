dep 'system', :hostname, :locale_name do
  requires 'set.locale'.with(locale_name), 'hostname'.with(hostname), 'secured ssh logins', 'lax host key checking', 'admins can sudo', 'tmp cleaning grace period', 'core software'
